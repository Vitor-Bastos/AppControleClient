...
public class ControleController {
	...
	@GetMapping(value = "/controle/lista")
	public String lista(
				Model model
			) {
	...
	public String incluir(
		...
		controle.setSolicitante(solicitanteService.obterPorId(controle.getSolicitante().getId()));
		
		List<Remedio> lista = new ArrayList<Remedio>();
		
		for(String id : remediosIds) {
			lista.add(remedioService.obterPorId(Integer.valueOf(id)));
		}
		...
		return "redirect:/controle/lista";
	}
	...
	public String consultar(
		...
		model.addAttribute("controle", controleService.consultar(id));
